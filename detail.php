				...
				<!-- area detail produk -->
							...
							<div class="row">
								<div class="col-md-6">
									<div class="image-product">
									    <img src="assets/img/produk/p11.jpg" alt="" class="img-fluid desc-img">
									</div>
								</div>
								<div class="col-md-6">
									<h2 class="desc-product-title">nama produk</h2>
									<span class="desc-product-price">RP.100.000</span>
									<p class="desc-product-info">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero, sint. Tempore nesciunt iste soluta quae magnam tempora totam ipsum earum optio praesentium necessitatibus odit quidem, consequuntur assumenda provident cumque perspiciatis!</p>
									<form action="POST">
					...
					<div class="box">
						<div class="box-body">
							...
							<p>
								<ul>
									<li>lorem ipsun dola smit</li>
									<li>velit resucardo</li>
									<li>unde set omnis odit aliquim</li>
								</ul>
							</p>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos consectetur, velit recusandae in, quis quos cumque optio voluptas. Quia dolores tenetur quo pariatur qui corporis, unde sed omnis odit aliquam!</p>
						</div>
